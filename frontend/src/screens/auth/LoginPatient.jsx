    ...
    return (
        <div className="min-h-screen bg-white p-6 flex flex-col justify-center">
            <div className="max-w-md mx-auto w-full">
                <h1 className="text-2xl font-bold text-primary mb-2">Patient Login</h1>
                <p className="text-gray-600 mb-8">Welcome back to Genova Health.</p>
                ...
                <p className="mt-4 text-center text-sm text-gray-600">
                    Don't have an account? <Link to="/auth/patient/signup" className="text-primary font-medium">Sign Up</Link>
                </p>
            </div>
        </div>
    );
